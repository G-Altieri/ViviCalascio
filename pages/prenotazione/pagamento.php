    ...
    <div class="relative sfondoCarta grid justify-items-center h-screen " id="sfondoCarta">
        ...
        <div id="metodoPagamento">
            <div class="relative mt-28 text-center py-4">
                <h1
                    ...
                    Scegli un metodo di <span
                        class="underline underline-offset-3 decoration-8 decoration-amber-800 ">Pagamento</span></h1>
            </div>
            <div class="w-4/5 mx-auto mt-20 grid grid-cols-1 md:grid-cols-2 place-content-center justify-items-center ">
                <div>
                    <button type="button" id="contanti"
                        class="text-gray-900 bg-green-100 hover:bg-green-200 border border-green-400 focus:ring-4 focus:outline-none focus:ring-gray-100 font-medium rounded-lg text-lg px-7 py-4 text-center inline-flex items-center  ">
                ...
                <div class="mt-8 md:mt-0">
                    <button type="button" id="carta"
                        class="text-gray-900 bg-blue-100 hover:bg-blue-200 border border-blue-400 focus:ring-4 focus:outline-none focus:ring-gray-100 font-medium rounded-lg text-lg px-8 py-4 text-center inline-flex items-center   ">
        ...
        <div id="riepilogo" class="hidden">
            ...
            <div id="ripilogoDati" class="text-2xl">
                <!-- Dati in tabella -->
                <div class="grid grid-cols-2 w-full justify-items-left bg-white border-b shadow-md rounded-lg text-sm sm:text-sm md:text-xl p-5 gap-4"
                ...
                <button onclick="location.href='/'" type="button"
                    class="mt-10 left-1/2  relative -translate-x-1/2 focus:outline-none text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2">Torna
                    alla Home</button>
            </div>
            <!-- Fine Riepilogo -->
        </div>
        ...
        <div id="rindirizzamentoView" class="hidden">
            <div class="relative mt-28 text-center py-4">
                <h1
                    class="mb-4 text-3xl font-extrabold leading-none tracking-tight text-gray-900 md:text-5xl lg:text-6xl ">
                    Stai per essere <span
                        class="underline underline-offset-3 decoration-8 decoration-amber-800 ">rindirizzato</span><br><br>
                    per
